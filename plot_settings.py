...
PLOT_MAPPING = {"App Usage": {
    ...
    "Activity Tracking": {"x": "date", "y": "activity", "hue": "category", "plot_name": "Activity Tracking",
                          ...
                          "sort": "date"},
    "Productivity": {"x": "date", "y": "total_active_time", "hue": "productivity", "plot_name": "Productivity Score",
                     "x_name": "Date", "y_name": "Usage Time", "legend_name": "Productivity", "plot_type": "line",
                     "sort": "date"},
    "Productivity Total": {"x": "productivity", "y": "total_active_time", "hue": "productivity",
                           "plot_name": "Productivity Score", "x_name": "Productivity", "y_name": "Usage Time",
                           "legend_name": None, "plot_type": "bar", "sort": "total_active_time"},
